package QualityResponAppFAM.Model.InputsDaoModel;
...
public class InputsDaoImpl implements InputsDao {
    ...
    public Inputs get(String nim, String nama) throws SQLException {
        ...
        if (rs.next()) {
            ...
            String reguler = rs.getString("semester");
            ...
            int p_kemahasiswaan = rs.getInt("p_perpustakaan");
    ...
    public int delete(Inputs inputs) throws SQLException {
        ...
        String sql = "DELETE FROM tb_penialaian_mahasiswa where nim = ? AND nama= ?";
